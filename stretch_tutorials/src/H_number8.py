...
class MultiPointCommand(hm.HelloNode):
	...
	def issue_multipoint_command(self):
		...
		point0.positions = [0.2, 0.0, 3.4, 0]
		...
		point1.positions = [0.3, 0.1, 2.0, 0.2]

		point2 = JointTrajectoryPoint()
		point2.positions = [0.5, 0.2, -1.0, 0.5 ]

		point3 = JointTrajectoryPoint()
		point3.positions = [0.6, 0.3, 0.0, 1]

		point4 = JointTrajectoryPoint()
		point4.positions = [0.8, 0.2, 1.0, 0.5]

		point5 = JointTrajectoryPoint()
		point5.positions = [0.5, 0.1, 0.0, -1.5]

		# Set trajectory_goal as a FollowJointTrajectoryGoal and define
		# the joint names as a list
		trajectory_goal = FollowJointTrajectoryGoal()
		trajectory_goal.trajectory.joint_names = ['joint_lift', 'wrist_extension', 'joint_wrist_yaw', 'joint_head_pan']
